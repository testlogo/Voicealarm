...
public class Audio {
    ...
    public void setTimeMillis(int timeMillis) {
     ...
     public static Audio createAudioFromFile(File inputFile) throws Exception {
        ...
        int pcmEncoding = format.containsKey(MediaFormat.KEY_AAC_ENCODED_TARGET_LEVEL) ? format.getInteger(MediaFormat.KEY_AAC_ENCODED_TARGET_LEVEL) : AudioFormat.ENCODING_PCM_16BIT;
        switch (pcmEncoding){
